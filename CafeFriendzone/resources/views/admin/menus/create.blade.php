        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="m-2 p-2">
                <form action="{{ route('admin.menus.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        <label for="image" class="block text-gray-700 text-sm font-bold mb-2">Price:</label>
                    ...
                    <button type="submit"
                        class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Store</button>
                </form>
            </div>
        </div>
    </div>
