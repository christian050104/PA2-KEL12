    ...
    <body class="bg-gray-100">
        <div class="flex min-h-screen">
            ...
            <div @click.away="open = false"
                class="flex flex-col flex-shrink-0 w-64 text-gray-700 bg-white dark:text-gray-200 dark:bg-gray-800"
                x-data="{ open: false }">
                            ...
                            <div class="px-2 py-2 bg-white rounded-md shadow dark:bg-gray-700">
                                ...
                                <form method="POST" action="{{ route('logout') }}">
                                    ...
                                    <x-responsive-nav-link :href="route('logout')"
                                        ...
                                        class="block px-4 py-2 mt-2 text-sm font-semibold bg-transparent
                                        rounded-lg dark:bg-transparent dark:hover:bg-gray-600 dark:focus:bg-gray-600
                                        dark:focus:text-white dark:hover:text-white dark:text-gray-200 md:mt-0
        ...
        <!-- Your script dependencies here -->
        <script src="https://cdnjs.cloudflare.com/ajax/libs/alpinejs/2.3.0/alpine.js"
            integrity="sha512-3tAVGDCjFOl9NtsWx3QJ1jyTl/jFpSMV9QXXEc+J2RXt3mTh2DBnbPQ52TUC9qqgLmE6yEyvC6InrPppL6k4Yw=="
